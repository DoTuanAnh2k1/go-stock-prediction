...
export default function Nasdaq() {
  ...
  return (
    <div className="content__inner fade">
          ...
          {preds.length === 0 ? (
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="tbl">
                ...
                <tbody>
                  {preds.slice((predPage - 1) * PRED_PER_PAGE, predPage * PRED_PER_PAGE).map((p, i) => {
            ...
            <TablePager total={preds.length} page={predPage} perPage={PRED_PER_PAGE} onChange={setPredPage} />
            </>
          )}
        </Panel>
          ...
          {confirmedResults.length === 0 ? (
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="tbl">
                ...
                <tbody>
                  {confirmedResults.slice((confirmedPage - 1) * PRED_PER_PAGE, confirmedPage * PRED_PER_PAGE).map((r, i) => {
            ...
            <TablePager total={confirmedResults.length} page={confirmedPage} perPage={PRED_PER_PAGE} onChange={setConfirmedPage} />
            </>
          )}
        </Panel>
      </div>
      ...
      <Panel title="Dự đoán vs Thực tế" sub={activeSym ? activeSym + ' · Tất cả thuật toán' : 'NASDAQ 100'} className="section-gap">
