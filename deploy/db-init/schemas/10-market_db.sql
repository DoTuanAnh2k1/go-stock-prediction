-- market_db — market data, predictions, simulation, pipeline, training, schedules.
-- Owned by prediction-svc. Split out of the former shared database.sql for
-- database-per-service isolation (auth tables -> auth_db/Flyway; service_instances -> registry_db).
-- ============================================================
