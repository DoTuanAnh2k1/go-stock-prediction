...
function buildMultiAlgoData(
  ...
  // treat as intraday even when not explicitly requested (e.g. crypto 30-min predictions).
  ...
  // When intraday: use prediction_date as key (fallback to dateField) so multiple
