...
export default function Nasdaq() {
  ...
  return (
    <div className="content__inner fade">
      <MarketTabs marketKey="nasdaq100" />
      <MarketClosedBanner marketKey="nasdaq100" />
      {/* KPI cards */}
      <div className="grid grid--kpis section-gap">
        {kpiItems.length === 0
          ? [1, 2, 3, 4].map((i) => (
      ...
      <Panel title={t.common.predVsActual} sub={activeSym ? activeSym + ' · ' + (predChartAlgo ? algoShort(predChartAlgo).short : t.common.allAlgos) : 'NASDAQ 100'} className="section-gap"
        tools={
