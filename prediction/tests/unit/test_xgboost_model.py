...
xgboost = pytest.importorskip("xgboost", reason="xgboost not installed — skipping XGBoost tests")

from src.algorithms.xgboost_model import MIN_DATA_POINTS, XGBoostPredictor
...
class TestXGBoostPredictor:
    ...
    def setup_method(self):
        self.algo = XGBoostPredictor()

    def test_get_key(self):
        assert self.algo.get_key() == "xgboost"

    def test_get_name(self):
        assert self.algo.get_name() == "XGBoost"
    ...
    def test_predict_insufficient_data_raises_value_error(self):
