...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/algorithms/backtest": {
            "get": {
                "description": "Runs a walk-forward backtest on up to 500 recent price points for the given stock symbol using Moving Average, LSTM, and ARIMA-GARCH algorithms. Returns MAE, RMSE, MAPE, and directional accuracy for each algorithm. Requires at least 150 historical data points.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Stock symbol (e.g. VCB)",
                        "name": "symbol",
                        "in": "query",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.AlgorithmComparisonDTO"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/crypto/predictions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status (pending, confirmed, wrong)",
                        "name": "status",
                        "in": "query"
                    },
                    {
        ...
        "/api/crypto/predictions/chart": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Algorithm name (e.g. lstm_nn)",
                        "name": "algorithm",
                        "in": "query"
                    },
                    {
        ...
        "/api/fuel/chart": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Fuel product type (e.g. ron95_iii, ron95_v, diezel_005s, dau_hoa)",
                        "name": "product",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.fuelChartResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.fuelLatestResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/fuel/predictions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by fuel product type",
                        "name": "product",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.fuelPredictionsPageResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/fuel/predictions/chart": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Fuel product type (e.g. ron95_iii, ron95_v)",
                        "name": "product",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.fuelPredictionChartResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.fuelPredictionsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.fuelPricesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/gold/chart": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Gold source (e.g. SJC, BTMC)",
                        "name": "source",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Product type (e.g. 1l, nhan_tron)",
                        "name": "product_type",
                        "in": "query"
                    },
                    {
        ...
        "/api/market/overview": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by sector (e.g. ngan-hang)",
                        "name": "sector",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by exchange code (e.g. HOSE)",
                        "name": "exchange",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Sort field: price or change_percent (default change_percent)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.MarketOverviewDTO"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/markets/{key}/predictions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Free-text search by symbol or company name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by algorithm key (e.g. lstm_nn)",
                        "name": "algorithm",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by prediction status (e.g. confirmed, pending)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort field (default prediction_date)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
        ...
        "/api/nasdaq/chart": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "NASDAQ symbol (e.g. AAPL, MSFT)",
                        "name": "symbol",
                        "in": "query"
                    },
                    {
        ...
        "/api/nasdaq/predictions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by NASDAQ symbol",
                        "name": "symbol",
                        "in": "query"
                    },
                    {
        ...
        "/api/predictions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by stock symbol (e.g. VCB)",
                        "name": "symbol",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by algorithm name (moving_average, lstm_nn, arima_garch, ema, ensemble)",
                        "name": "algorithm",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by status — use 'confirmed' for reconciled predictions",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.PredictionListDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/modelsapi.PredictionAccuracyDTO"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/predictions/accuracy-trend": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/modelsapi.AccuracyTrendPointDTO"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/predictions/compare/{symbol}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by algorithm (moving_average, lstm_nn, arima_garch, ema, ensemble)",
                        "name": "algorithm",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.PredictionCompareDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/predictions/error-distribution": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorDistributionDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.PredictionDetailDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/schedules/{key}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Job key (e.g. crawler_daily)",
                        "name": "key",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "New cron expression and enabled state",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/stocks/watchlist": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Comma-separated stock symbols (e.g. VCB,VIC,FPT)",
                        "name": "symbols",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.StockWatchlistDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "1D",
                        "description": "Time period (1D, 1W, 1M, 3M, 6M, 1Y)",
                        "name": "period",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "default": "1h",
                        "description": "Data interval (e.g. 5m, 1h, 1d)",
                        "name": "interval",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.StockChartDataDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.StockCurrentPriceDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.StockDetailDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/stocks/{symbol}/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Number of days of history (1-1000, overrides period)",
                        "name": "days",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "default": "1M",
                        "description": "Time period shorthand (1D, 1W, 1M, 3M, 6M, 1Y)",
                        "name": "period",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/modelsapi.StockHistoricalDataDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/training/history": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Number of sessions to return (1-50, default 10)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by log level: error or info",
                        "name": "level",
                        "in": "query"
                    }
                ],
        ...
        "/api/training/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Training log ID (numeric) or session UUID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/trigger/gold-historical-backtest": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/trigger/historical-backtest": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Minimum data points before first prediction (default 30)",
                        "name": "train_window",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Fold size — data points between retraining (default 6)",
                        "name": "step_size",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Target market key: VN30, GOLD, NASDAQ100, CRYPTO, FUEL (default: all)",
                        "name": "market",
                        "in": "query"
                    }
                ],
        ...
        "/api/trigger/stock-history": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Number of historical days to crawl (default 365, max 1000)",
                        "name": "days",
                        "in": "query"
                    }
                ],
        ...
        "/api/trigger/train": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Training request (algorithm is optional)",
                        "name": "body",
                        "in": "body",
                        "schema": {
    ...
    "definitions": {
        "modelsapi.AccuracyTrendPointDTO": {
            "type": "object",
            "properties": {
                "arima_garch": {
                    "type": "number"
        ...
        "modelsapi.AlgorithmComparisonDTO": {
            "type": "object",
            "properties": {
                "algorithms": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/modelsapi.AlgorithmPerformanceDTO"
                    }
                },
                "best_algorithm": {
                    "type": "string"
        ...
        "modelsapi.AlgorithmPerformanceDTO": {
            "type": "object",
            "properties": {
                "accuracy_rate": {
                    "type": "number"
        ...
        "modelsapi.MarketOverviewDTO": {
            ...
            "properties": {
                ...
                "stocks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/modelsapi.StockFlatDTO"
                    }
                },
                "stocks_page": {
                    "type": "integer"
        ...
        "modelsapi.PredictionAccuracyDTO": {
            "type": "object",
            "properties": {
                "accuracy_rate": {
                    "type": "number"
        ...
        "modelsapi.PredictionDetailDTO": {
            ...
            "properties": {
                ...
                "stock": {
                    "$ref": "#/definitions/modelsapi.StockDTO"
                },
                "target_date": {
                    "type": "string"
                }
        ...
        "modelsapi.PredictionListDTO": {
            "type": "object",
            "properties": {
                "filters": {
                    "$ref": "#/definitions/modelsapi.PredictionFilterDTO"
                },
                "page": {
                    "type": "integer"
                },
        ...
        "modelsapi.StockChartDataDTO": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/modelsapi.ChartPointDTO"
                    }
                },
                "interval": {
                    "description": "\"1m\", \"5m\", \"15m\", \"1h\", \"1d\"",
                    "type": "string"
                },
                "period": {
                    "type": "string"
                ...
                "volume": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/modelsapi.VolumePointDTO"
                    }
                }
            }
        },
        "modelsapi.StockCurrentPriceDTO": {
            "type": "object",
            "properties": {
                "change": {
                    "type": "number"
                ...
                "market_status": {
                    "description": "\"open\", \"closed\", \"pre_market\", \"after_hours\"",
                    "type": "string"
                },
                "open": {
                    "type": "number"
        ...
        "modelsapi.StockDetailDTO": {
            ...
            "properties": {
                ...
                "history": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/modelsapi.StockPriceDTO"
                    }
                },
                "predictions": {
                    "type": "array",
                ...
                "stats": {
                    "$ref": "#/definitions/modelsapi.StockStatsDTO"
                },
                "stock": {
                    "$ref": "#/definitions/modelsapi.StockDTO"
                }
        ...
        "modelsapi.StockHistoricalDataDTO": {
            "type": "object",
            "properties": {
                "end_date": {
                    "type": "string"
        ...
        "modelsapi.StockStatsDTO": {
            ...
            "properties": {
                ...
                "percent_change": {
                    "description": "% thay đổi từ đầu period",
                    "type": "number"
                },
                "price_change": {
                    "description": "Thay đổi từ đầu period",
        ...
        "server.ErrorDistributionDTO": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.ErrorDistributionPoint"
                    }
                }
            }
        },
        "server.ErrorDistributionPoint": {
            "type": "object",
            "properties": {
                "actual_change_pct": {
                    "type": "number"
        ...
        "server.PredictionCompareDTO": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.PredictionComparePoint"
                    }
                },
                "symbol": {
                    "type": "string"
        ...
        "server.fuelLatestResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.fuelLatestItem"
                    }
                },
                "updated_at": {
                    "type": "string"
        ...
        "server.fuelPredictionChartPoint": {
            "type": "object",
            "properties": {
                "actual_price": {
                    "type": "number"
        ...
        "server.fuelPredictionChartResponse": {
            "type": "object",
            "properties": {
                "algorithm": {
                    "type": "string"
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.fuelPredictionChartPoint"
                    }
                },
                "product_type": {
                    "type": "string"
        ...
        "server.fuelPredictionsPageResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.fuelPredictionItem"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "server.fuelPredictionsResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "server.fuelPricesResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.fuelPricePoint"
                    }
                },
                "product_type": {
                    "type": "string"
