...
func (c *Client) UpsertCryptoIntradayPrice(p *modelsdb.CryptoIntradayPrice) error {
...
func (c *Client) GetCryptoIntradayByRange(coinID string, from, to time.Time) ([]modelsdb.CryptoIntradayPrice, error) {
