...
func (c *Client) CreateNasdaqPrice(ctx context.Context, p *modelsdb.NasdaqPrice) error {
...
func (c *Client) UpsertNasdaqPrice(ctx context.Context, p *modelsdb.NasdaqPrice) error {
...
func (c *Client) GetNasdaqPricesByDateRange(ctx context.Context, symbol string, from, to time.Time) ([]modelsdb.NasdaqPrice, error) {
...
func (c *Client) GetLatestNasdaqPrice(ctx context.Context, symbol string) (*modelsdb.NasdaqPrice, error) {
...
func (c *Client) GetNasdaqSymbols(ctx context.Context) ([]string, error) {
	var symbols []string
	err := c.db(ctx).Model(&modelsdb.NasdaqPrice{}).
		Distinct("symbol").
...
func (c *Client) GetAllNasdaqPricesForSymbol(ctx context.Context, symbol string) ([]modelsdb.NasdaqPrice, error) {
	var prices []modelsdb.NasdaqPrice
...
func (c *Client) BulkCreateNasdaqPredictions(ctx context.Context, preds []modelsdb.NasdaqPrediction) error {
...
func (c *Client) DeleteNasdaqPredictionsBeforeDate(ctx context.Context, before time.Time) error {
...
func (c *Client) CreateNasdaqPrediction(ctx context.Context, p *modelsdb.NasdaqPrediction) error {
	return c.db(ctx).Create(p).Error
}
...
func (c *Client) GetNasdaqPredictions(ctx context.Context, symbol, algorithm string, limit int) ([]modelsdb.NasdaqPrediction, error) {
...
func (c *Client) GetLatestNasdaqPredictions(ctx context.Context) ([]modelsdb.NasdaqPrediction, error) {
	var preds []modelsdb.NasdaqPrediction
	subQuery := c.db(ctx).Model(&modelsdb.NasdaqPrediction{}).
...
func (c *Client) GetLatestConfirmedNasdaqPredictions(ctx context.Context) ([]modelsdb.NasdaqPrediction, error) {
	var preds []modelsdb.NasdaqPrediction
	subQuery := c.db(ctx).Model(&modelsdb.NasdaqPrediction{}).
...
func (c *Client) GetNasdaqPredictionsByDateRange(ctx context.Context, symbol string, from, to time.Time) ([]modelsdb.NasdaqPrediction, error) {
	var preds []modelsdb.NasdaqPrediction
...
func (c *Client) GetNasdaqPredictionsPage(ctx context.Context, page, limit int, search, algorithm, status, sortBy, sortDir string) ([]modelsdb.NasdaqPrediction, int64, error) {
	var preds []modelsdb.NasdaqPrediction
	var total int64
	...
	query := c.db(ctx).Model(&modelsdb.NasdaqPrediction{})
