...
func (c *Client) UpsertNasdaqIntradayPrice(ctx context.Context, p *modelsdb.NasdaqIntradayPrice) error {
...
func (c *Client) GetNasdaqIntradayByRange(ctx context.Context, symbol string, from, to time.Time) ([]modelsdb.NasdaqIntradayPrice, error) {
