...
func (c *Client) UpsertSP500IntradayPrice(p *modelsdb.SP500IntradayPrice) error {
...
func (c *Client) GetSP500IntradayByRange(symbol string, from, to time.Time) ([]modelsdb.SP500IntradayPrice, error) {
