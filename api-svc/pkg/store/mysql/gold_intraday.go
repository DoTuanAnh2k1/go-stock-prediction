...
func (c *Client) UpsertGoldIntradayPrice(_ context.Context, p *modelsdb.GoldIntradayPrice) error {
...
func (c *Client) GetGoldIntradayByRange(_ context.Context, source string, from, to time.Time) ([]modelsdb.GoldIntradayPrice, error) {
