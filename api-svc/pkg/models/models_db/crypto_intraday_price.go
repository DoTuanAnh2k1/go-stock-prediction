...
type CryptoIntradayPrice struct {
	...
	OpenPrice *decimal.Decimal `gorm:"type:numeric(30,8)" json:"open_price"`
	HighPrice *decimal.Decimal `gorm:"type:numeric(30,8)" json:"high_price"`
	LowPrice  *decimal.Decimal `gorm:"type:numeric(30,8)" json:"low_price"`
